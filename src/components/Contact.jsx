...
{icon}
            ...
            <form action="https://getform.io/f/aronllyb" method='POST' className='xl:pl-10 2xl:pl-20' >
<div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
    <div className="mb-4">
<label htmlFor="name" className='label reveal-up'>Name</label>

<input type="text" name="name" id="name" placeholder='Sai Tarun' className='text-field reveal-up' required />
    </div>

   <div className="mb-4">
<label htmlFor="email" className='label reveal-up'>Email</label>

<input type="email" name="email" id="email" autoComplete='email' placeholder='saitarun1199@gmail.com' className='text-field reveal-up' required />
    </div> 
