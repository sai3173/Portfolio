...
href={href  }
    ...
    className='w-12 h-12 grid place-items-center ring-inset ring-2
     ring-zinc-50/5 rounded-lg transition-[background-color] hover:bg-zinc-50 hover:text-zinc-950
...
{icon}
            ...
            <form action="https://getform.io/f/allzlywa" method='POST' className='xl:pl-10 2xl:pl-20' >
<div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
    <div className="mb-4">
<label htmlFor="name" className='label reveal-up'>Name</label>

<input type="text" name="name" id="name" placeholder='Kummara Naresh' className='text-field reveal-up' required />
    </div>

   <div className="mb-4">
<label htmlFor="email" className='label reveal-up'>Email</label>

<input type="email" name="email" id="email" autoComplete='email' placeholder='kummaranaresh1114@gmail.com' className='text-field reveal-up' required />
    </div> 

    <div className="">
<label htmlFor="message" className='label reveal-up'>Message</label>
<textarea name="message" id="message"  placeholder='Hi!' className='text-field resize-y min-h-32 max-h-80 reveal-up' required></textarea>
    </div>
